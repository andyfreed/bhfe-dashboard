...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-slate-200/80 bg-white/80 backdrop-blur-sm text-slate-950 shadow-modern hover:shadow-modern-lg transition-all duration-200 animate-in",
      className
    )}
    {...props}
  />
